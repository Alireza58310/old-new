        ...
        if (request.method === "POST" && url.pathname === "/api/deploy") {
            try {
                ...
                if (isNetra) {
                    ...
                    // اسم ورکر کاملا رندومه و فقط شامل کلمه‌ی netroooo هست (یبار اول، یبار وسط، یبار آخر - رندوم).
                    workerName = buildRandomWorkerName("netroooo");
                    ...
                    // اسم ورکر کاملا رندومه و فقط شامل کلمه‌ی zessss هست (یبار اول، یبار وسط، یبار آخر - رندوم).
                    workerName = buildRandomWorkerName("zessss");
...
async function reloadZeusPanel(scriptName) {
    ...
    try {
        ...
        const PANEL_TYPE_CONFIG = {
            ...
            'zeus-kv': {
                storageKey: 'zeus_kv_deployer_sources_v1',
                // اگه سورس مخصوص نسخه‌ی KV زئوس رو جدا داری، همین آدرس رو با «افزودن سورس» عوض کن.
                defaultSource: { label: 'پیش‌فرض (نسخه KV زئوس)', url: 'https://raw.githubusercontent.com/Alireza58310/old-new/refs/heads/main/old/zeus.js' }
            },
            netra: {
